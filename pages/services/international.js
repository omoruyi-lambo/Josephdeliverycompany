  ...
  return (
    <ServicePageTemplate
      ...
      features={[
        ...
        { icon: 'fa-solid fa-door-open', title: 'Door-to-Door', desc: 'Pickup from your address in Nigeria, delivered to the door of the recipient internationally.' },
      ...
      steps={[
        ...
        { n: '04', title: 'International Delivery', desc: 'Our partner network delivers to the door of the recipient with full tracking.' },
      ]}
      faqs={[
        ...
        { q: 'What items are prohibited internationally?', a: 'Prohibited items include currency, narcotics, weapons, counterfeit goods, and certain food products. Check the destination country import restrictions before booking.' },
      ]}
    />
  );
}
