  ...
  return (
    <ServicePageTemplate
      ...
      features={[
        ...
        { icon: 'fa-solid fa-shield-halved', title: 'Included Insurance', desc: 'Basic coverage up to ₦50,000 included. Extended cover available.' },
      ...
      faqs={[
        ...
        { q: 'Can I change the delivery address after booking?', a: 'Address changes are accepted up to 2 hours after booking is confirmed, subject to a ₦500 amendment fee.' },
      ]}
    />
  );
}
